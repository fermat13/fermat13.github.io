...
2021-2025 (expected)
:   **PhD in Economics** at the University of Milan-Bicocca, in partnership with Catholic University of the Sacred Hearth of Milan. Currently at the third year, working on my research project. The first year was fully devoted to standard courses (e.g. Microeconomics, Econometrics, Research Methods), the second year on specific ones (e.g. Health economics, Network Economics, Python)
...
Promotion to **serie C** while playing for Volley Modica (position: libero)
2012 to 2015 - Finalist in various high school mathematics and physics competitions

Skills
----------
Programming - R, Stata, GIS, Python, basics of Dynare, MatLab, NetLogo, Gretl
